...
public class DefaultAlipayServiceImpl implements AliPayServiceAPI {
    ...
    public AliPayInfoVO getQRCode(String orderId,String tempPath) {
        //获取二维码地址
        String filePath = trade_precreate(orderId,tempPath);
    ...
    // 测试当面付2.0生成支付二维码
    public String trade_precreate(String orderId,String tempPath) {
        String filePath="";
        //获取订单信息
       ...
       // extendParams.setSysServiceProviderId("2088100200300400500");
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                filePath = String.format(tempPath+"/qr-%s.png",response.getOutTradeNo());
